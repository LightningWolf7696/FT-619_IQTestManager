...
#ifdef _USES_DYNAMIC
typedef	IQ_TM_RETURN ( WINAPI * P_TM_RegisterTechnologyDll)(const TM_STR technology, const TM_STR technologyDllFileName, TM_ID *technologyID);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_Run)(TM_ID technologyID, const TM_STR functionKeyword);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_ClearParameters)(TM_ID technologyID);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_AddDoubleParameter)(TM_ID technologyID, const TM_STR paramName, const double paramValue);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_AddIntegerParameter)(TM_ID technologyID, const TM_STR paramName, const int paramValue);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_AddStringParameter)(TM_ID technologyID, const TM_STR paramName, const TM_STR paramValue);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_GetDoubleReturnPair)(TM_ID technologyID, TM_STR paramName, int bufferSize, TM_STR unit, int unitSize, TM_STR helpText, int helpTextSize, double* paramValue, int order);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_GetIntegerReturnPair)(TM_ID technologyID, TM_STR paramName, int bufferSize, TM_STR unit, int unitSize, TM_STR helpText, int helpTextSize, int* paramValue, int order);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_GetStringReturnPair)(TM_ID technologyID, TM_STR paramName, int bufferSize, TM_STR unit, int unitSize, TM_STR helpText, int helpTextSize, TM_STR paramValue, int paramValueBufferSize, int order);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_GetStringReturn)(TM_ID technologyID, const TM_STR paramName, TM_STR paramValue, int bufferSize);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_GetIntegerReturn)(TM_ID technologyID, const TM_STR paramName, int* paramValue);
typedef	IQ_TM_RETURN ( WINAPI * P_TM_GetDoubleReturn)(TM_ID technologyID, const TM_STR paramName, double* paramValue);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_RegisterTechnology(const TM_STR technology, TM_ID *technologyID);
 ...
 */
TM_API IQ_TM_RETURN __stdcall TM_UnregisterTechnology(const TM_STR technology);
 ...
 *              - GPS
 */
TM_API IQ_TM_RETURN __stdcall TM_RegisterTechnologyDll(const TM_STR technology, TM_STR technologyDllFileName, TM_ID *technologyID);
 ...
 */
TM_API IQ_TM_RETURN __stdcall TM_UnregisterTechnologyDll(const TM_STR technology, TM_ID *technologyID);
 ...
 */
TM_API IQ_TM_RETURN __stdcall TM_GetTechnologyInfo(char *technologyName, 
                                                int bufferSize, 
                                                int *technologyIndex, 
 ...
 * \return TM_ERR_OK if no errors
 */
TM_API IQ_TM_RETURN __stdcall TM_GetTechnologyIndex(char *technologyName, 
                                                 int *technologyIndex, 
                                                 int *testFunctionCount);

TM_API IQ_TM_RETURN __stdcall TM_GetFunctionKeyword(const char* technologyName, 
 ...
 */
TM_API IQ_TM_RETURN __stdcall TM_InstallCallbackFunction(TM_ID technologyID, const TM_STR functionKeyword, int (*pointerToFunction)(void) );
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_Run(TM_ID technologyID, const TM_STR functionKeyword);
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_ClearParameters(TM_ID technologyID);

TM_API IQ_TM_RETURN __stdcall TM_AddIntegerParameter(TM_ID technologyID, const TM_STR paramName, const int paramValue);
TM_API IQ_TM_RETURN __stdcall TM_AddDoubleParameter(TM_ID technologyID, const TM_STR paramName, const double paramValue);
TM_API IQ_TM_RETURN __stdcall TM_AddStringParameter(TM_ID technologyID, const TM_STR paramName, const TM_STR paramValue);
TM_API IQ_TM_RETURN __stdcall TM_GetIntegerParameter(TM_ID technologyID, const TM_STR paramName, int* paramValue);
TM_API IQ_TM_RETURN __stdcall TM_GetDoubleParameter(TM_ID technologyID, const TM_STR paramName, double* paramValue);
TM_API IQ_TM_RETURN __stdcall TM_GetStringParameter(TM_ID technologyID, const TM_STR paramName, TM_STR paramValue, int bufferSize);
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_ClearReturns(TM_ID technologyID);
TM_API IQ_TM_RETURN __stdcall TM_AddIntegerReturn(TM_ID technologyID, const TM_STR paramName, const int paramValue);
TM_API IQ_TM_RETURN __stdcall TM_AddDoubleReturn(TM_ID technologyID, const TM_STR paramName, const double paramValue);
TM_API IQ_TM_RETURN __stdcall TM_AddStringReturn(TM_ID technologyID, const TM_STR paramName, const TM_STR paramValue);
TM_API IQ_TM_RETURN __stdcall TM_AddArrayDoubleReturn(TM_ID technologyID, const TM_STR paramName, const double *paramValue, const int arraySize);

TM_API IQ_TM_RETURN __stdcall TM_AddUnitReturn(TM_ID technologyID, const TM_STR paramName, const TM_STR unit);
TM_API IQ_TM_RETURN __stdcall TM_GetUnitReturn(TM_ID technologyID, const TM_STR paramName, TM_STR unitValue, int bufferSize);
TM_API IQ_TM_RETURN __stdcall TM_AddHelpTextReturn(TM_ID technologyID, const TM_STR paramName, const TM_STR helpText);

TM_API IQ_TM_RETURN __stdcall TM_GetIntegerReturn(TM_ID technologyID, const TM_STR paramName, int* paramValue);
TM_API IQ_TM_RETURN __stdcall TM_GetDoubleReturn(TM_ID technologyID, const TM_STR paramName, double* paramValue);
TM_API IQ_TM_RETURN __stdcall TM_GetStringReturn(TM_ID technologyID, const TM_STR paramName, TM_STR paramValue, int bufferSize);
TM_API IQ_TM_RETURN __stdcall TM_GetArrayDoubleReturnSize(TM_ID technologyID, const TM_STR paramName,int* arraySize);
TM_API IQ_TM_RETURN __stdcall TM_GetArrayDoubleReturn(TM_ID technologyID, const TM_STR paramName, double *paramValue, const int arraySize);
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_GetIntegerParamPair(TM_ID technologyID, 
                                                  TM_STR paramName, 
                                                  int bufferSize, 
                                                  TM_STR unit, 
                                                  int unitSize, 
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_GetIntegerReturnPair(TM_ID technologyID, 
                                                   TM_STR paramName, 
                                                   int bufferSize, 
                                                   TM_STR unit, 
                                                   int unitSize, 
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_GetDoubleParamPair(TM_ID technologyID, 
                                                 TM_STR paramName, 
                                                 int bufferSize, 
                                                 TM_STR unit, 
                                                 int unitSize, 
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_GetDoubleReturnPair(TM_ID technologyID, 
                                        TM_STR paramName, 
                                        int bufferSize, 
                                         TM_STR unit, 
                                         int unitSize, 
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_GetStringParamPair(TM_ID technologyID, 
                                                 TM_STR paramName, 
                                                 int bufferSize, 
                                                 TM_STR unit, 
                                                 int unitSize, 
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_GetStringReturnPair(TM_ID technologyID, 
                                        TM_STR paramName, 
                                        int bufferSize, 
                                         TM_STR unit, 
                                         int unitSize, 
 ...
 * \return TM_ERR_INVALID_TECHNOLOGY_ID The specified Technology ID is invalid
 */
TM_API IQ_TM_RETURN __stdcall TM_GetArrayDoubleReturnPair(TM_ID technologyID, 
                                                       TM_STR paramName, 
                                                       int bufferSize, 
                                                       TM_STR unit, 
                                                       int unitSize, 
 ...
 *
 */
TM_API char* __stdcall TM_GetErrorString(IQ_TM_RETURN errorNum);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_WiFiConvertFrequencyToChannel(int freq, int* channel);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_WiFiConvertChannelToFrequency(int channel, int *freq);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_WiFiConvertDataRateNameToIndex(TM_STR name, int* index);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_WiFiConvertDataRateNameToIQ2010ExtIndex(TM_STR name, int* dataRateIndex);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_GetVersion(TM_STR paramValue, int bufferSize);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_UpdatePathLossAtFrequency(TM_ID	technologyID,
                                                        int		freqMHz,
                                                        double *pathLoss,
                                                        int		pathLossCount,
														int		indicatorTxRx);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_UpdatePathLossByFile(TM_ID technologyID, TM_STR pathLossFileName, int indicatorTxRx);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_GetPathLossAtFrequency(TM_ID  technologyID,
                                                     int	freqMHz,
                                                     double *pathLoss,
                                                     int	pathLossIndex,
													 int	indicatorTxRx);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_GetDutInfo(TM_STR dutSerialNumber, int dutSerialNumberBufferSize,
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_SetDutInfo(TM_STR deviceSerialNumber,
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_CheckMultiWaveformIndexMap(bool *mapIsEmpty);
 ...
 * \return TM_ERR_OK if no errors
 */
TM_API IQ_TM_RETURN __stdcall TM_ClearMultiWaveformIndexMap(void);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_AddMultiWaveformWithIndex(TM_STR waveformName, int index);
 ...
 *
 */
TM_API IQ_TM_RETURN __stdcall TM_GetMultiWaveformIndex(TM_STR waveformName, int *index);                                         
#endif
#endif
