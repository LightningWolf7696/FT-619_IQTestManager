/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_Core/inc/QMSL_QPST_PortManagement.h#6 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /** Detect Sahara Mode. This function will detect whether a phone has entered Sahara mode 
   ...
   \warning This function requires QPST version 2.7.395.  The QMSL must run in QPST mode. 
   *******************************************************************************/
   QLIB_API unsigned char QLIB_QPST_DetectSaharaMode( HANDLE hResourceContext );

   /******************************************************************************/
   /** Gets last Server Event. This functionality will be useful to understand phone state. 
   ...
   *******************************************************************************/
   ...
   QLIB_API void QLIB_QPST_GetLastServerEvent(HANDLE hResourceContext,unsigned long* lastServerEvent);
